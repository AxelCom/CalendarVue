<template>
    <form @submit.prevent="handleSubmit">
        ...
        <div class="input-holder">
            <textarea placeholder="description" rows="4" v-model="event.data.description"></textarea>
        </div>
        <div class="input-holder">
...
<script>
    ...
    export default {
        ...
        methods: {
            async handleSubmit() {
                const datestart = format(this.event.dateStart, 'DD-MM-YYYY');
                const dateend = format(this.event.dateEnd, 'DD-MM-YYYY');
                const event = {
                    ...this.event,
                    datestart,
                    dateend
